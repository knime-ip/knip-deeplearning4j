 ...
 * ImgPlusValue to Double[].
 * 
 * @author David Kolb, KNIME.com GmbH
 */
public class ImgPlusValueToDoubleArrayConverterFactory implements DataCellToJavaConverterFactory<ImgPlusValue, Double[]> {

	/**
	 * Implementation of {@link DataCellToJavaConverter} which converts from ImgPlusValue to
	 * Double[]. Images are converted by iterating the image and copying each pixel, hence images
	 * will be just flattened.
	 *
	 * @author David Kolb, KNIME.com GmbH
	 * @param <T>
	 */
	private class ImgPlusValueToINDArrayConverter<T extends RealType<T>> implements DataCellToJavaConverter<ImgPlusValue<T>, Double[]>{
		@Override
		public Double[] convert(ImgPlusValue<T> source) throws Exception {
	...
	@Override
	public DataCellToJavaConverter<ImgPlusValue, Double[]> create() {
	...
	public String getIdentifier() {
		return getClass().getName() + "(" + ImgPlusValue.class.getSimpleName() + "," + Double[].class.toString() + "," + ""
	            + ")";
	}
